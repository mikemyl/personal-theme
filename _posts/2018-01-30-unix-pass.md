...
<pre><code class="bash"><span class="noselect">$ </span>pass init mike@mikemylonakis.com </code></pre>
...
<pre><code class="bash"><span class="noselect">$ </span>pass git remote add origin git@bitbucket.org:username/private-git-repo.git </code></pre>
